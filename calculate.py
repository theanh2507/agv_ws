...
class modbus_node(Node):
    ...
    def read_register(self):
        ...
        self.data_encoder = [self.value_right_encoder, self.value_right_encoder]
        msg =  Int64MultiArray()
        msg.data = [self.value_right_encoder, self.value_right_encoder]

        self.get_logger().info(f"Encode R: {self.value_right_encoder} L: {self.value_right_encoder}")
    ...
    def caculate_position(self):
        ...
        self.current_time = now.sec * 1_000_000_000 + now.nanosec  # thời gian hiện tại (nanosec)
